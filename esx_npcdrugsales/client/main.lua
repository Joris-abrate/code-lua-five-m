          ...
          if IsPedInAnyVehicle(ped) == false then
            ...
            if pedType ~= 28 and IsPedAPlayer(ped) == false then
              ...
              if distance <= 2 and ped  ~= GetPlayerPed(-1) and ped ~= oldped then
                ...
                if has == true then
---------------------->[Message - Vendre]< ---------------------- 
                drawTxt(0.90, 1.40, 1.0,1.0,0.4, "~r~APPUYEZ SUR E POUR VENDRE DE LA DROGUE", 255, 255, 255, 255)
...
AddEventHandler('checkR', function(valeur)
  has = valeur
end)
...
AddEventHandler('notifyc', function()
    ...
    if crossing ~= nil then
      ...
      TriggerServerEvent('esx_phone:send', "police", "Une personne louche vend de la drogue " .. streetName .. " et " .. crossing, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
